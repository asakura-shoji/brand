...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container m-auto">
    	...
    	<main>
	    	...
	    	<ul class="flex flex-wrap sm:-mx-4 mb-20">
	    		<li class="px-4 w-100 sm:w-1/3">
	    			<div>
	    				<img class="mb-2" src="{{ asset('images/home/main_15.jpg') }}">
	    				<div>
	    					<h3 class="text-xl font-bold mb-4">ブランドの立ち上げをサポート</h3>
	    					<div>
	    		...
	    		<li class="px-4 w-100 sm:w-1/3">
	    			<div>
	    				<img class="mb-2" src="{{ asset('images/home/main_16.jpg') }}">
	    				<div>
	    					<h3 class="text-xl font-bold mb-4">あなたにピッタリのショッピングサイトを作成</h3>
	    					<div>
	    		...
	    		<li class="px-4 w-100 sm:w-1/3">
	    			<div>
	    				<img class="mb-2" src="{{ asset('images/home/main_19.jpg') }}">
	    				<div>
	    					<h3 class="text-xl font-bold mb-4">簡単管理画面で運用に時間が取られず、好きなことに集中できる</h3>
	    					<div>
	    	...
	    	<div class="text-center">
	    		...
	    		<div>
	    			<a href="#form">
	    				<img class="w-100 sm:w-1/2 m-auto mb-12" src="{{ asset('images/home/application_btn.png') }}">
	    			</a>
	    		</div>
	    	</div>
	    	<div class="bg-gray-100 py-8 px-4">
	    		<img class="w-2/3 m-auto mb-8" src="{{ asset('images/home/main_13.png') }}">
	    		<ul>
	    	...
	    	<div class="my-12">
	    		<img src="{{ asset('images/home/1648984397447.jpg') }}">
	    	</div>
    		<form class="mb-12 px-4 sm:px-0" id="form" method="POST" action="{{ url('application') }}">
    			@csrf
    			<div class="sm:flex flex-wrap items-center justify-center mb-2">
                    <label for="name" class="w-100 sm:w-36 pr-6 text-right">
                        お名前
                    </label>
                    <input id="name" type="text" class="w-100 sm:w-80 h-8 bg-gray-100 rounded @error('name')  border-red-500 @enderror"
                ...
                <div class="sm:flex flex-wrap items-center justify-center mb-2">
                    ...
                    <input id="kana" type="text" class="w-100 sm:w-80 h-8 bg-gray-100 rounded @error('kana')  border-red-500 @enderror"
                ...
                <div class="sm:flex flex-wrap items-center justify-center mb-2">
                    ...
                    <input id="email" type="email"
                        class="w-100 sm:w-80 h-8 bg-gray-100 rounded @error('email') border-red-500 @enderror" name="email"
                ...
                <div class="sm:flex flex-wrap items-center justify-center mb-8">
                    <label for="tel" class="w-100 sm:w-36 pr-6 text-right">
                        電話番号
                    </label>

                    <input id="tel" type="text"
                        class="w-100 sm:w-80 h-8 bg-gray-100 rounded @error('tel') border-red-500 @enderror" name="tel"
                ...
                <div class="text-center">
                	<button type="submit">
                		<img width="120" src="{{ asset('images/home/form_submit.jpg') }}">
                	</button>
                </div>
    		</form>
    	</main>
